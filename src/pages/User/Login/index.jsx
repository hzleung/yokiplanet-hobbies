...
import { useIntl, history, connect, FormattedMessage, useModel } from 'umi';
...
const Login = (props) => {
  ...
  const fetchUserInfo = async (data) => {
    const resp = await currentUser(data);
    if (resp && resp.success) {
      await localStorage.setItem("userInfo", JSON.stringify(resp.data));
    }
  };
